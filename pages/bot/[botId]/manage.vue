...
<template>
    <div v-if="botData && owned" class="flex justify-center">
            ...
            <div class="my-6 flex flex-col gap-4">
                ...
                <ul class="list-none p-0 flex flex-col gap-2">
                    <li v-for="developer in botData.developers" class="bg-white/20 p-4 flex justify-between gap-4">
                        ...
                        <div>
                            <button class="text-btn" @click="removeDeveloper(developer.id)"
                                v-if="botData.developers.length !== 1"> Remove </button>
                        </div>
                    </li>
                </ul>
                <div class="w-full flex justify-center">
    ...
    <div class="w-full flex flex-col items-center" v-else-if="botData && !owned">
